Пользовательское соглашение OKO (Условия предоставления услуг)
...
Настоящее Пользовательское соглашение (далее «Соглашение» или «Условия») является юридически обязывающим договором между вами (далее «вы» или «Пользователь») и OKO (далее «мы» или «OKO»).

B. Сфера применения

Настоящее Соглашение регулирует ваш доступ к веб-сайту github.com/oko-trading/okotrading (далее «Веб-сайт») и его использование, а также загрузку, установку и использование операционной системы OKO AI для торговли (далее «Программное обеспечение»).
...
Лицензия AGPL-3.0: Мы явно информируем вас о том, что исходный код Программного обеспечения OKO предоставляется вам на условиях лицензии GNU Affero General Public License v3.0 (AGPL-3.0) (далее «AGPL-3.0»).
...
НАСТОЯЩЕЕ СОГЛАШЕНИЕ (ВМЕСТЕ С ЛИЦЕНЗИЕЙ НА ПРОГРАММНОЕ ОБЕСПЕЧЕНИЕ AGPL-3.0) ПРЕДСТАВЛЯЕТ СОБОЙ ПОЛНОЕ СОГЛАШЕНИЕ МЕЖДУ ВАМИ И OKO ОТНОСИТЕЛЬНО ПРЕДМЕТА ДОГОВОРА.
