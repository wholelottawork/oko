          ...
          {adminMode ? (
            <form onSubmit={handleAdminLogin} className="space-y-5">
              ...
              <button type="submit" disabled={loading} className={`${btnPrimary}`} style={btnPrimaryStyle}>
                {loading ? (language === 'zh' ? '验证中...' : 'Verifying...') : (language === 'zh' ? '登录' : 'Sign in')}
              </button>
            </form>
          ) : step === 'setup-otp' ? (
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-sm" style={{ color: 'var(--text-secondary)' }}>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="font-medium mb-0.5" style={{ color: 'var(--text-primary)' }}>
                      {language === 'zh' ? '扫描并验证' : 'Scan & verify'}
                    </p>
                    <p className="text-xs">
                      {language === 'zh' ? '扫描上方二维码，然后输入下方 6 位验证码' : 'Scan the code above, then enter the 6-digit code below'}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <form onSubmit={handleOTPVerify} className="space-y-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  style={btnPrimaryStyle}
                >
                  {loading ? (language === 'zh' ? '验证中...' : 'Verifying...') : (language === 'zh' ? '验证' : 'Verify')}
                </button>
              </div>
            </form>
          )}
