    ...
    >
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <div>
          ...
          <div className="font-mono font-semibold" style={{ color: avgPnl >= 0 ? 'var(--binance-green)' : 'var(--binance-red)' }}>
            {avgPnl >= 0 ? '+' : ''}
            {formatNumber(avgPnl)}
          </div>
        </div>
    ...
    <div className="space-y-6">
      ...
      {stats && (
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
          ...
          <StatCard
            ...
            color={(stats.total_pnl || 0) >= 0 ? 'var(--binance-green)' : 'var(--binance-red)'}
      ...
      {stats && (
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
          ...
          <StatCard
            ...
            color={(stats.total_pnl || 0) - (stats.total_fee || 0) >= 0 ? 'var(--binance-green)' : 'var(--binance-red)'}
      ...
      >
            ...
            <div className="flex rounded overflow-hidden" style={{ border: '1px solid var(--surface-tertiary)' }}>
              {['all', 'LONG', 'SHORT'].map((side) => (
                <button
                  ...
                  style={{
                    background: filterSide === side ? 'var(--surface-tertiary)' : 'transparent',
        ...
        <div
          ...
          style={{ borderTop: '1px solid var(--surface-tertiary)', color: 'var(--text-secondary)' }}
        >
          {/* Left: Count info */}
            ...
            {totalPages > 1 && (
              <div className="flex items-center gap-1">
                <button
                  ...
                  style={{
                    background: currentPage === 1 ? 'transparent' : 'var(--surface-tertiary)',
                    color: 'var(--text-primary)',
                  }}
                >
                  «
                ...
                <button
                  ...
                  className="px-2 py-1 rounded text-xs transition-colors disabled:opacity-30"
                  style={{
                    background: currentPage === totalPages ? 'transparent' : 'var(--surface-tertiary)',
                    color: 'var(--text-primary)',
                  }}
                >
                  ›
