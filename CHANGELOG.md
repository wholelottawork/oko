...
All notable changes to the OKO project will be documented in this file.
...
This is a **major breaking update** that completely transforms OKO from a static config-based system to a modern web-based trading platform.
...
- [GitHub Repository](https://github.com/oko-trading/okotrading)
