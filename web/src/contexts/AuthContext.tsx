...
import { getAuthIntent, clearAuthIntent } from '../components/landing/LoginModal'
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    // First check whether it is administrator mode (obtained using cached system configuration)
    getSystemConfig()
      .then(() => {
        // No more simulated login in administrator mode; unified check of local storage
      ...
      .catch((err) => {
        ...
        // When an error occurs, continue checking local storage
        const savedToken = localStorage.getItem('auth_token')
        const savedUser = localStorage.getItem('auth_user')
