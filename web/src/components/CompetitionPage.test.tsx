...
/**
 * Regression tests for displaying missing competition data.
 *
 * A missing or invalid total_pnl_pct should render as an em dash, not "NaN%"
 * or a zero value.
 */

describe('CompetitionPage - Data Validation Logic (PR #678)', () => {
  /**
   * Tests the data-validity guard introduced by PR #678.
   */
   ...
   *  gap should only be calculated if the data is valid
   */
  ...
  /**
   * Test display logic
   *  After the fix, "—" should be displayed instead of "NaN%" or "0.00%"
   */
  ...
  /**
   *  Test lead/lag message display logic
   *   Display "Leading" or "Lagging" messages only if data is valid
   */
  ...
  describe('edge cases', () => {
    ...
    it('should handle Infinity as invalid (produces NaN in calculations)', () => {
      ...
      // Infinity itself is not a NaN, but can cause problems in subtraction operations
