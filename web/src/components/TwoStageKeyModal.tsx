    ...
    try {
      ...
      if (navigator.clipboard) {
        try {
          ...
          toast.success('Obfuscated string copied to the clipboard')
        } catch {
          ...
          toast.error('Copy failed. Please copy the obfuscated string manually.')
        }
      } else {
        setClipboardStatus('failed')
        setObfuscationLog([
        ...
        toast('Your browser does not support automatic copying. Please copy manually.')
      }
