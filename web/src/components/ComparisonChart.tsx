    ...
    return (
      <div className="flex flex-col items-center justify-center py-20">
        <div className="w-20 h-20 rounded-2xl flex items-center justify-center mb-4"
          ...
          <BarChart3 className="w-10 h-10" style={{ color: 'var(--accent-primary)', opacity: 0.6 }} />
        </div>
  ...
  const CustomTooltip = ({ active, payload }: any) => {
    if (active && payload && payload.length) {
      ...
      return (
        ...
        >
          <div className="flex items-center gap-2 mb-3 pb-2" style={{ borderBottom: '1px solid var(--surface-tertiary)' }}>
            ...
            <button
              ...
              style={{
                background: selectedPeriod === period.key
                  ...
                  : 'rgba(43, 49, 57, 0.5)',
                color: selectedPeriod === period.key ? 'var(--accent-primary)' : 'var(--text-secondary)',
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {traderStats.slice(0, 3).map((trader, idx) => (
            <div key={trader.trader_id}
                 ...
                 style={{
                   background: idx === 0 ? 'var(--accent-primary-bg)' : 'rgba(43, 49, 57, 0.5)',
      ...
      <div className="relative rounded-xl overflow-hidden"
        ...
        <ResponsiveContainer width="100%" height={420}>
          ...
          >
            ...
            <CartesianGrid strokeDasharray="3 3" stroke={getCssVar('--surface-secondary')} vertical={false} />
