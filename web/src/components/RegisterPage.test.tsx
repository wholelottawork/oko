...
/**
 * Regression tests for password validation consistency in RegisterPage.
 *
 * The UI validation supplied by PasswordChecklist must remain aligned with
 * the validation used during submission.
 *
 * These tests cover the shared rules, including the allowed special characters.
 */

describe('RegisterPage - Password Validation Consistency (Logic Tests)', () => {
  /**
   * Verifies that the validation rules match PasswordChecklist.
   */
  describe('password validation rules', () => {
    ...
    it('should require special character from allowed set', () => {
      // According to the settings in RegisterPage.tsx, the special character pattern is /[@#$%!&*?]/
      ...
      // Special characters not in the allowed list should not pass
  ...
  /**
   * Test complete password strength verification
   *   Simulate the complete verification logic of PasswordChecklist
   */
   ...
   *   Ensure that in the normal display (lines 229-251) and error prompts (lines 300-323) of RegisterPage
   *   Use the same special character regular /[@#$%!&*?]/
   */
  describe('special character consistency', () => {
    it('should use consistent special character regex across all validations', () => {
      // Both PasswordChecklists in RegisterPage should use the same specialCharsRegex
   ...
   *   Make sure that after removing the isStrongPassword function, all checks pass PasswordChecklist
   */
  describe('refactoring consistency verification', () => {
    it('should have removed duplicate isStrongPassword function', () => {
      // This test verifies the intent of the refactoring:
      // Before refactoring, there was an isStrongPassword function
      // After refactoring, this function should be removed and only the verification of PasswordChecklist should be used.

      // We verify the consistency by simulating the logic of PasswordChecklist
    ...
    it('should use consistent validation logic across the component', () => {
      // Verify the consistency of the verification logic
      const validation1 = {
        minLength: 8,
        requireCapital: true,
      ...
      // The same configuration should be used in the normal display and error prompts of RegisterPage
      const validation2 = {
        minLength: 8,
        requireCapital: true,
        requireLowercase: true,
