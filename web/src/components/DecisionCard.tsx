...
// Action type configuration - clean white icons
...
function ActionCard({ action, language, onSymbolClick }: { action: DecisionAction; language: Language; onSymbolClick?: (symbol: string) => void }) {
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(135deg, var(--surface-secondary) 0%, #181C21 100%)',
    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <div
            ...
            style={{ background: action.success ? 'var(--binance-green)' : 'var(--binance-red)' }}
          />
        </div>
      </div>
      ...
      {isOpen && (
        <div className="grid grid-cols-4 gap-3 mt-3 pt-3" style={{ borderTop: '1px solid var(--surface-tertiary)' }}>
          {/* Entry Price */}
          ...
          {/* Stop Loss */}
          <div className="text-center">
            <div className="text-xs mb-1" style={{ color: 'var(--binance-red)' }}>
              {t('stopLoss', language)}
            </div>
            <div className="font-mono font-semibold" style={{ color: 'var(--binance-red)' }}>
          ...
          {/* Take Profit */}
          <div className="text-center">
            <div className="text-xs mb-1" style={{ color: 'var(--binance-green)' }}>
              {t('takeProfit', language)}
            </div>
            <div className="font-mono font-semibold" style={{ color: 'var(--binance-green)' }}>
      ...
      {isOpen && action.stop_loss && action.take_profit && action.price && (
        <div className="mt-3 pt-3 flex items-center justify-between" style={{ borderTop: '1px solid var(--surface-tertiary)' }}>
              ...
              return (
                <>
                  <div className="flex gap-1">
                    ...
                    <span style={{ color: 'var(--binance-green)' }}>{ratio.toFixed(1)}</span>
                  </div>
                  <div
      ...
      {/* Reasoning */}
      {action.reasoning && (
        <div className="mt-3 pt-3" style={{ borderTop: '1px solid var(--surface-tertiary)' }}>
          <div className="text-xs line-clamp-2 flex items-start gap-2" style={{ color: 'var(--text-secondary)' }}>
  ...
  return (
    <div
      ...
      style={{
        ...
        background: 'linear-gradient(180deg, var(--surface-secondary) 0%, #181C21 100%)',
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div
          ...
          style={
            decision.success
              ? { background: 'var(--binance-green-bg)', color: 'var(--binance-green)', border: '1px solid rgba(14, 203, 129, 0.3)' }
              : { background: 'var(--binance-red-bg)', color: 'var(--binance-red)', border: '1px solid rgba(246, 70, 93, 0.3)' }
          }
        >
      ...
      <div className="space-y-2">
        ...
        {decision.system_prompt && (
          <div>
            ...
            >
              <div className="flex items-center gap-2">
                <Settings size={18} className="text-white shrink-0" />
        ...
        {decision.input_prompt && (
          <div>
            ...
            >
              <div className="flex items-center gap-2">
                <Inbox size={18} className="text-white shrink-0" />
