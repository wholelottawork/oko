...
export function RiskControlEditor({
  ...
  const t = (key: string) => {
    const translations: Record<string, string> = {
      ...
      btcEthPositionValueRatioDesc: 'Max position value = equity × this ratio (CODE ENFORCED)',
      altcoinPositionValueRatio: 'Altcoin Position Value Ratio',
      altcoinPositionValueRatioDesc: 'Max position value = equity × this ratio (CODE ENFORCED)',
