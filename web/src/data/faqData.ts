 ...
 * Comprehensive FAQ covering all aspects of OKO
 *
 * Categories:
...
export const faqCategories: FAQCategory[] = [
  // ===== 1. GETTING STARTED =====
  {
    ...
    items: [
      {
        id: 'what-is-oko',
        questionKey: 'faqWhatIsOKO',
        answerKey: 'faqWhatIsOKOAnswer',
      },
      {
        id: 'how-does-it-work',
  ...
  // ===== 6. SECURITY =====
  {
    ...
    items: [
      ...
      {
        id: 'can-oko-steal-funds',
        questionKey: 'faqCanOKOStealFunds',
        answerKey: 'faqCanOKOStealFundsAnswer',
      },
    ],
  },
